...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error instanceof ApiError ? error.message : "There was an error creating your account. Please try again.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  const handleSocialSignup = async (provider: string) => {
    ...
    try {
      // This would be replaced with actual social signup implementation
      await new Promise((resolve) => setTimeout(resolve, 1500))

      toast({
        title: "Social signup successful",
      ...
      toast({
        title: "Signup failed",
        description: `There was an error signing up with ${provider}. Please try again.`,
        variant: "destructive",
      })
    } finally {
